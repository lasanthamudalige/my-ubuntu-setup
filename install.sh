...
sudo apt update && sudo apt install ubuntu-restricted-extras vim curl gnome-clocks gnome-boxes gnome-notes vlc build-essential python3-pip python3-tk -y # Enter 'y' to download
