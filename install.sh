...
sudo apt update && sudo apt install ubuntu-restricted-extras fish kitty htop neofetch vim git curl gnome-clocks gnome-dictionary vlc build-essential python3-pip python3-tk tlp -y # Enter 'y' to download
